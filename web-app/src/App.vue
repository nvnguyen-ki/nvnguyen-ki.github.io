    ...
    >
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item
            href="https://drive.google.com/file/d/https://drive.google.com/file/d/1SdYgEYV5bdkvg2QfESuJhkfGGckjq4Mk/view?usp=sharing"
            target="_blank"
...
#home_animation a::before,
#home_animation a::after {
  content: "";
  height: 15px;
  width: 15px;
  position: absolute;
...
#home_animation a:hover:before,
#home_animation a:hover:after {
